img_scale = (128, 128)  # height, width
...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=1),
    bbox_head=dict(
        type='YOLOXHead', num_classes=len(classes), in_channels=320, feat_channels=320),
...
work_dir = '/content/drive/MyDrive/ColabNotebooks/Practice/logs/ft_detectors/yolox'
device = 'cuda'
