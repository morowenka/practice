...
data_root = '/content/drive/MyDrive/ColabNotebooks/Practice/datasets/VehicleDataset/'
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)
classes = ('bus','car','cyclist','jeep',
           'misc','pedestrian','truck','van')
checkpoint_config = dict(interval=1)
work_dir = '/content/drive/MyDrive/ColabNotebooks/Practice/logs/ft_detectors/faster_rcnn'
log_config = dict(
    interval=10,
    hooks=[
